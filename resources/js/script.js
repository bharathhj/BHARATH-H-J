$(document).ready(function() {
    ...
    $('.js--scroll-to-start').click(function () {
     ...
     $('.js--scroll-to-pform').click(function () {
       $('html, body').animate({scrollTop: $('.js--section-pform').offset().top}, 1100); 
    });
    $('.js--scroll-to-qrcode').click(function () {
       $('html, body').animate({scrollTop: $('.js--section-qrcode').offset().top}, 1000); 
    });
